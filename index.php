...
<html lang="en">
  <head>
    <title>Aplikasi Kasir Optik Zac'O</title>
    <!-- Bootstrap core CSS -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="cek_login.php" method="post">
		        ...
		        <h2 class="form-login-heading"><center><img src="config/optik.jpg" ></center><p><center>Aplikasi Kasir Optik Zac'O</center></p></h2>
